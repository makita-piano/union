<template>
  <div class="grid col-12">
    <div class="col-12 header-img-div">
      ...
      <h1 class="header-img-h1">PLAN</h1>
    </div>
    ...
    <div class="grid-center col-12" style="margin-top: 5rem;padding-bottom: 5rem">
      ...
      <div class="grid col-12 plan-div" style="padding: 0 1rem">
        ...
        ワーケーションなど、10人以上の団体様で宿泊したい方にオススメです。</p>
        <p>料金：35,000円~</p>
      </div>
    </div>
    <div class="grid-center col-12 bg-grey" style="margin-top: 5rem;padding-bottom: 5rem">
    ...
    <div class="grid-center col-12 bg-grey" style="margin-top: 2rem;padding-bottom: 5rem">
      ...
      <div class="grid col-12 plan-div" style="padding: 0 1rem">
        <p>
          ...
          ・お食事がメインのイベントの場合、食材の持ち込みはご相談ください。
        </p>
      </div>
    </div>
  </div>
...
export default {
  head() {
    return {
      title: "PLAN｜La Union 福島（ラウニオン）",
      meta: [
        { hid: 'og:title', property: 'og:title', content: 'PLAN｜La Union 福島（ラウニオン）' }
      ]
    }
  },
}
